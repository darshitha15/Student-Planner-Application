//
//  TimeTableDetailsVC.swift
//  Project
//
//  Created by geetharani on 07/12/19.
...
class TimeTableDetailsVC: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource,UITextFieldDelegate {
    
    //@IBOutlet weak var courseLbl: UILabel!
    @IBOutlet weak var courseSch_picker: UIPickerView!
    @IBOutlet weak var roomnum_txt: UITextField!
    @IBOutlet weak var timings_txt: UITextField!
    ...
    override func viewDidLoad()
    {
        ...
        InstructorName.delegate = self
        roomnum_txt.delegate = self
        timings_txt.delegate = self
    ...
    @IBAction func saveClassData(_ sender: UIButton)
        {
            ...
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
              ...
              newUser.setValue(courseStr, forKey: "course")
              newUser.setValue(classStr, forKey: "classType")
              newUser.setValue(schdule_str, forKey: "schedules")
              newUser.setValue(teacher, forKey: "instructor")
              newUser.setValue(timings_txt.text, forKey: "timings")
              newUser.setValue(roomnum_txt.text, forKey: "roomNum")
